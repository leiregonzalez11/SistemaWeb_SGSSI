...
CREATE USER 'sgssiworks'@'%' IDENTIFIED VIA mysql_native_password USING PASSWORD('ADGgHWlReYMDImd8');
GRANT SELECT, INSERT, UPDATE, DELETE ON `database`.* TO 'sgssiworks'@'%'  REQUIRE NONE WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0; 
